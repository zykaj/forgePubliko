...
class ForgotPasswordController extends FrontController
{
    ...
    // -------------------------------------------------------
    // Laravel overwrites for loading PublikoAL views
    // -------------------------------------------------------
    ...
    {
        // Meta Tags
        Meta::set('title', getMetaTag('title', 'password'));
        Meta::set('description', strip_tags(getMetaTag('description', 'password')));
        Meta::set('keywords', getMetaTag('keywords', 'password'));

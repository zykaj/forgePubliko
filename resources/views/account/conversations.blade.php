									...
									<tr>
										...
										<td>
											<div style="word-break:break-all;">
												...
												|&nbsp;
												<a href="{{ url('account/conversations/' . $conversation->id . '/messages') }}">
										...
										<td class="action-td">
											<div>
												<p>
													<a class="btn btn-default btn-sm" href="{{ url('account/conversations/' . $conversation->id . '/messages') }}">
														<i class="icon-eye"></i> {{ t('View') }}
													</a>
												</p>
												<p>
													<a class="btn btn-danger btn-sm delete-action" href="{{ url('account/conversations/' . $conversation->id . '/delete') }}">
														<i class="fa fa-trash"></i> {{ t('Delete') }}
													</a>
												</p>
											</div>

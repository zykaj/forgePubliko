	...
	public static function getFields($diskName)
	{
		$fields = [
			...
			[
				...
				'label'             => 'Show country flag on top',
				'type'              => 'checkbox',
				'hint'              => '<br>',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
			...
			[
				...
				'label'             => 'Allow users to pay the Packages in their country currency',
				'type'              => 'checkbox',
				'hint'              => 'package_currency_by_country_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],

	...
	public static function getFields($diskName)
	{
		$fields = [
			[
				'name'  => 'separator_1',
				'type'  => 'custom_html',
				'value' => 'other_html_alerts_boxes',
			],
			[
				'name'              => 'cookie_consent_enabled',
				'label'             => 'Cookie Consent Enabled',
				'type'              => 'checkbox',
				'hint'              => 'Enable Cookie Consent Alert to comply for EU law',
				'wrapperAttributes' => [
			...
			[
				...
				'label'             => 'Show Tips Notification Messages',
				'type'              => 'checkbox',
				'hint'              => 'show_tips_messages_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],
			...
			[
				'name'  => 'separator_3',
				'type'  => 'custom_html',
				'value' => 'other_html_conversation',
			],
			[
				'name'              => 'timer_new_messages_checking',
				'label'             => 'Timer for New Messages Checking',
				'type'              => 'number',
				'hint'              => 'timer_new_messages_checking_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],
			...
			[
				'name'  => 'separator_5',
				'type'  => 'custom_html',
				'value' => 'other_html_mobile_app',
			],
			[
				'name'              => 'ios_app_url',
				'label'             => 'App Store',
				'type'              => 'text',
				'hint'              => 'Available on the App Store with the given URL',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],
			[
				...
				'label'             => 'Google Play',
				'type'              => 'text',
				'hint'              => 'Available on Google Play with the given URL',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],
			[
				'name'  => 'separator_6',
				'type'  => 'custom_html',
				'value' => 'other_html_number_format',
			],
			[
				'name'  => 'decimals_superscript',
				'label' => 'Decimals Superscript',
				'type'  => 'checkbox',
			],
			[
				'name'  => 'cookie_sep',
				'type'  => 'custom_html',
				'value' => 'cookie_sep_value',
			],
			[
				'name'              => 'cookie_expiration',
				'label'             => 'cookie_expiration_label',
				'type'              => 'number',
				'hint'              => 'cookie_expiration_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],

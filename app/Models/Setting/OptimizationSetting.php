	...
	public static function getFields($diskName)
	{
		$fields = [
			[
				...
				'type'  => 'custom_html',
				'value' => 'caching_system_sep_value',
			],
			[
				'name'              => 'cache_driver',
				'label'             => 'cache_driver_label',
			...
			[
				...
				'label'             => 'cache_expiration_label',
				'type'              => 'number',
				'hint'              => 'cache_expiration_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],
			[
				...
				'type'  => 'custom_html',
				'value' => 'cache_driver_info',
			],
			[
				'name'  => 'memcached_sep',
				'type'  => 'custom_html',
				'value' => 'memcached_sep_value',
			],
			[
				'name'              => 'memcached_persistent_id',
				'label'             => 'memcached_persistent_id_label',
				'type'              => 'text',
				'hint'              => 'memcached_persistent_id_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],
			...
			[
				...
				'label'             => 'memcached_sasl_username_label',
				'type'              => 'text',
				'hint'              => 'memcached_sasl_username_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],
			[
				...
				'label'             => 'memcached_sasl_password_label',
				'type'              => 'text',
				'hint'              => 'memcached_sasl_password_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],
			[
				...
				'type'  => 'custom_html',
				'value' => 'memcached_servers_sep_value',
			],
			[
			...
			[
				'name'  => 'redis_sep',
				'type'  => 'custom_html',
				'value' => 'redis_sep_value',
			],
			[
				'name'              => 'redis_client',
				'label'             => 'redis_client_label',
				'type'              => 'select2_from_array',
				'options'           => [
					'predis'   => 'Predis',
					'phpredis' => 'PhpRedis',
				],
				'hint'              => 'redis_client_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],
			...
			[
				...
				'label'             => 'redis_cluster_activation_label',
				'type'              => 'checkbox',
				'hint'              => 'redis_cluster_activation_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
			...
			[
				'name'              => 'redis_cluster',
				'label'             => 'redis_cluster_label',
				'type'              => 'select2_from_array',
				'options'           => [
					'predis' => 'Predis',
					'redis'  => 'Redis',
				],
				'hint'              => 'redis_cluster_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],
			...
			[
				...
				'type'  => 'custom_html',
				'value' => 'redis_server_sep_value',
			],
			[
				'name'              => 'redis_host',
				'label'             => 'redis_host_label',
				'type'              => 'text',
				'hint'              => 'redis_host_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],
			...
			[
				'name'              => 'redis_port',
				'label'             => 'redis_port_label',
				'type'              => 'number',
				'hint'              => 'redis_port_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],
			...
			[
				...
				'type'  => 'custom_html',
				'value' => 'redis_clusters_sep_value',
			],
			[
			...
			[
				...
				'type'  => 'custom_html',
				'value' => 'lazy_loading_sep_value',
			],
			[
				'name'  => 'lazy_loading_activation',
				'label' => 'lazy_loading_activation_label',
				'type'  => 'checkbox',
				'hint'  => 'lazy_loading_activation_hint',
			],
			[
				'name'  => 'minify_html_sep',
				'type'  => 'custom_html',
				'value' => 'minify_html_sep_value',
			],
			[
				'name'  => 'minify_html_activation',
				'label' => 'minify_html_activation_label',
				'type'  => 'checkbox',
				'hint'  => 'minify_html_activation_hint',
			],
		];

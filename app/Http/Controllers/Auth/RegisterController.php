...
class RegisterController extends FrontController
{
	...
	public function showRegistrationForm()
	{
		...
		// Meta Tags
		Meta::set('title', getMetaTag('title', 'register'));
		Meta::set('description', strip_tags(getMetaTag('description', 'register')));
		Meta::set('keywords', getMetaTag('keywords', 'register'));
	...
	public function finish()
	{
		...
		// Meta Tags
		Meta::set('title', session('message'));
		Meta::set('description', session('message'));

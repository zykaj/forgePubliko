				...
				<div class="col-md-9 page-content">
					<div class="inner-box">
						...
						if (isset($conversation) && !empty($conversation) > 0):
							...
							// Conversation URLs
							$consUrl = url('account/conversations');
							$conDelAllUrl = url('account/conversations/' . $conversation->id . '/messages/delete');
						?>
									...
									<tr>
										@if ($message->from_user_id == auth()->user()->id)
											...
											<td class="action-td" style="width:10%">
												<div>
													<p>
														<?php $conDelUrl = url('account/conversations/' . $conversation->id . '/messages/' . $message->id . '/delete'); ?>

...
class ConversationsController extends AccountBaseController
{
	...
	public function index()
	{
		...
		// Meta Tags
		Meta::set('title', t('Conversations Received'));
		Meta::set('description', t('Conversations Received on', ['appName' => config('settings.app.app_name')]));
	...
	public function messages($conversationId)
	{
		...
		// Meta Tags
		Meta::set('title', t('Messages Received'));
		Meta::set('description', t('Messages Received on', ['appName' => config('settings.app.app_name')]));

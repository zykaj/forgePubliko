...
class PageController extends FrontController
{
	...
	public function pricing()
	{
		...
		// Meta Tags
		Meta::set('title', getMetaTag('title', 'pricing'));
		Meta::set('description', strip_tags(getMetaTag('description', 'pricing')));
		Meta::set('keywords', getMetaTag('keywords', 'pricing'));
	...
	public function contact()
	{
		...
		// Meta Tags
		Meta::set('title', getMetaTag('title', 'contact'));
		Meta::set('description', strip_tags(getMetaTag('description', 'contact')));
		Meta::set('keywords', getMetaTag('keywords', 'contact'));

...
class PostsController extends AccountBaseController
{
	...
	public function getMyPosts($postId = null)
	{
		...
		// Meta Tags
		Meta::set('title', t('my_ads'));
		Meta::set('description', t('my_ads_on', ['appName' => config('settings.app.app_name')]));
	...
	public function getArchivedPosts($postId = null)
	{
		...
		// Meta Tags
		Meta::set('title', t('my_archived_ads'));
		Meta::set('description', t('my_archived_ads_on', ['appName' => config('settings.app.app_name')]));
	...
	public function getFavouritePosts()
	{
		...
		// Meta Tags
		Meta::set('title', t('my_favourite_ads'));
		Meta::set('description', t('my_favourite_ads_on', ['appName' => config('settings.app.app_name')]));
	...
	public function getPendingApprovalPosts()
	{
		...
		// Meta Tags
		Meta::set('title', t('my_pending_approval_ads'));
		Meta::set('description', t('my_pending_approval_ads_on', ['appName' => config('settings.app.app_name')]));
	...
	public function getSavedSearch(HttpRequest $request)
	{
		...
		// Meta Tags
		Meta::set('title', t('my_saved_search'));
		Meta::set('description', t('my_saved_search_on', ['appName' => config('settings.app.app_name')]));

...
class UpdateController extends Controller
{
	...
	{
		// If Admin User(s) is not found, Allow unsecured upgrade
	...
	public function run()
	{
		...
		if (version_compare($lastVersion, $currentVersion, '<=')) {
			...
			flash("You website is up-to-date! PublikoAL v" . $lastVersion . ' is currently the newest version available.')->info();

<?php
// Admin User Photo
if (file_exists(storage_path('app/public/' . auth()->user()->photo))) {
	$userPhoto = imgUrl(auth()->user()->photo, 'user');
} else {
	$userPhoto = Gravatar::get(auth()->user()->email);
}
?>
<header class="topbar">
	<?php
						...
						<ul class="dropdown-user list-style-none">
							<li>
								<div class="dw-user-box p-3 d-flex">
									<div class="u-img">
										<img src="{{ $userPhoto }}" alt="user" class="rounded" width="80">
									</div>
